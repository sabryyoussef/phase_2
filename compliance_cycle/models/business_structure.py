...
class BusinessShareholder(models.Model):
    ...
    passport = fields.Many2one("client.document", string="Passport")
    uae_resident = fields.Boolean(string="UAE Resident")
    eid_copy = fields.Many2one("client.document", string="EID Copy")
    residence_visa_copy = fields.Many2one(
        "client.document", string="Residence Visa Copy"
    )
    current_visa = fields.Many2one("client.document", string="Current Visa")
    entry_stamp = fields.Many2one("client.document", string="Entry Stamp")
    trade_license = fields.Many2one("client.document", string="Trade License")
